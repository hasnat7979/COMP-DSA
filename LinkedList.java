...
void Insertion_in_SLL_Asscending(){
    Node ptr3 = Start;
        while(ptr3.Next != null){
            if((ptr3.info) <= (ptr3.Next.info)){
                   ptr3 = ptr3.Next;
        }
            else{
                System.out.println("Linked List in not Sorted in Asscending Order");
                return;
            }
        }
    Node ptr = Start;
    ...
    Node ptr3 = Start;
        while(ptr3.Next != null){
            if((ptr3.info) >= (ptr3.Next.info)){
                ...
                System.out.println("Linked List in not Sorted in Descending Order");
                return;
            }
        }
